...
public Tail1( String fileName ) { _fileName = fileName; }
public Tail1( String fileName, int tailSize )
{
...
if( argsLength == 1 )
{
Tail1 tail1 = new Tail1( args[0] );
System.out.println( tail1.run().toString() );
}
if( argsLength == 2 )
{
Tail1 tail1 = new Tail1( args[0], new Integer( args[1] ).intValue() );
System.out.println( tail1.run().toString() );
}
}
}